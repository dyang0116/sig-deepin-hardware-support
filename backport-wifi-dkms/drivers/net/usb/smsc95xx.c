...
#define linkmode_and linkmode_and_arm64
#define linkmode_test_bit linkmode_test_bit_arm64
#define linkmode_resolve_pause linkmode_resolve_pause_arm64
#define phy_get_pause phy_get_pause_arm64
...
static void
linkmode_resolve_pause(const unsigned long *local_adv,
...
static void
phy_get_pause(struct phy_device *phydev, bool *tx_pause, bool *rx_pause)
{
