...
static int mt7921_load_firmware(struct mt7921_dev *dev)
{
	...
	// ret = mt76_get_field(dev, MT_CONN_ON_MISC, MT_TOP_MISC2_FW_N9_RDY);// FLAGSP：525c469e5de9
	// if (ret && mt76_is_mmio(&dev->mt76)) {// FLAGSP：525c469e5de9
	// 	dev_dbg(dev->mt76.dev, "Firmware is already download\n");// FLAGSP：525c469e5de9
	// 	goto fw_loaded;// FLAGSP：525c469e5de9
	// }// FLAGSP：525c469e5de9
