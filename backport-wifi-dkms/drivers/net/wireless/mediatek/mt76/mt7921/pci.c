...
// https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/drivers/net/wireless/mediatek/mt76/mt7921?h=v6.4-rc5&id=3d78c46423c6567ed25ca033e086865b1b4d5ae1
// FLAGSP:3d78c464
...
// Signed-off-by: Guan Wentao <guanwentao@uniontech.com>
	...
	cancel_work_sync(&dev->reset_work);// FLAGSP:3d78c464

	mt7921_tx_token_put(dev);
	// mt7921_mcu_drv_pmctrl(dev);
	__mt7921_mcu_drv_pmctrl(dev);// FLAGSP:3d78c464
			    ...
			    const struct pci_device_id *id)
{
	...
	ret = mt7921e_mcu_fw_pmctrl(dev);// FLAGSP：525c469e5de9
	if (ret)// FLAGSP：525c469e5de9
		goto err_free_dev;// FLAGSP：525c469e5de9
...
static void mt7921_pci_shutdown(struct pci_dev *pdev)// FLAGSP: f23a0cea
{// FLAGSP: f23a0cea
// 	struct mt76_dev *mdev = pci_get_drvdata(pdev);// FLAGSP: f23a0cea
// 	struct mt7921_dev *dev = container_of(mdev, struct mt7921_dev, mt76);// FLAGSP: f23a0cea
// 	struct mt76_connac_pm *pm = &dev->pm;// FLAGSP: f23a0cea
// // FLAGSP: f23a0cea
// 	cancel_delayed_work_sync(&pm->ps_work);// FLAGSP: f23a0cea
// 	cancel_work_sync(&pm->wake_work);// FLAGSP: f23a0cea
// // FLAGSP: f23a0cea
// 	/* chip cleanup before reboot */// FLAGSP: f23a0cea
// 	mt7921_mcu_drv_pmctrl(dev);// FLAGSP: f23a0cea
// 	mt7921_dma_cleanup(dev);// FLAGSP: f23a0cea
// 	mt7921_wfsys_reset(dev);// FLAGSP: f23a0cea
// https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/drivers/net/wireless/mediatek/mt76?h=v6.4-rc5&id=9270270d62191b7549296721e8d5f3dc0df01563
// FLAGSP: 9270270d
...
// Signed-off-by: Felix Fietkau <nbd@nbd.name>
// Signed-off-by: Guan Wentao <guanwentao@uniontech.com>
	printk("%s Debug:Enter %s func wait\n",pci_name(pdev),__func__);// FLAGSP:9270270d
	mt7921_pci_remove(pdev);// FLAGSP: 9270270d
	printk("%s Debug:Out %s func wait\n",pci_name(pdev),__func__);// FLAGSP:9270270d
}// FLAGSP: f23a0cea


// https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/drivers/net/wireless/mediatek/mt76/mt7921?h=v6.4-rc5&id=f23a0cea8bd6
// FLAGSP: f23a0cea
...
struct pci_driver mt7921_pci_driver = {
	...
	.shutdown	= mt7921_pci_shutdown,// FLAGSP: f23a0cea
#ifdef CONFIG_PM
