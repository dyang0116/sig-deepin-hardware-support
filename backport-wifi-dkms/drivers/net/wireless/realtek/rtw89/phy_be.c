...
static void rtw89_phy_ch_info_init_be(struct rtw89_dev *rtwdev)
{
	...
	rtw89_phy_write32_mask(rtwdev, R_CHINFO_ELM_SRC, B_CHINFO_ELM_BITMAP, 0x40303);
	rtw89_phy_write32_mask(rtwdev, R_CHINFO_ELM_SRC, B_CHINFO_SRC, 0x0);
	rtw89_phy_write32_mask(rtwdev, R_CHINFO_TYPE_SCAL, B_CHINFO_TYPE, 0x1);
	rtw89_phy_write32_mask(rtwdev, R_CHINFO_TYPE_SCAL, B_CHINFO_SCAL, 0x0);
}
