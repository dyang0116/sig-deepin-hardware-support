...
static_assert(offsetof(struct rtw8851b_efuse, path_a_tssi) == 0x210);
static_assert(offsetof(struct rtw8851b_efuse, channel_plan) == 0x2b8);
static_assert(offsetof(struct rtw8851b_efuse, tx_bb_swing_2g) == 0x2c6);
static_assert(offsetof(struct rtw8851b_efuse, rfe_type) == 0x2ca);
static_assert(offsetof(struct rtw8851b_efuse, country_code) == 0x2cb);
static_assert(offsetof(struct rtw8851b_efuse, path_a_therm) == 0x2d0);
static_assert(offsetof(struct rtw8851b_efuse, rx_gain_5g_high) == 0x2dc);
static_assert(offsetof(struct rtw8851b_efuse, e) == 0x400);
static_assert(offsetof(struct rtw8851b_efuse, u.mac_addr) == 0x488);
