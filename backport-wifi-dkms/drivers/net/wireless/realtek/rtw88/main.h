...
#define ieee80211_request_smps(__vif, __link_id, __mode) \
	ieee80211_request_smps(__vif, __mode)

#define ieee80211_beacon_get_tim(__hw, __vif, __ofst_p, __len_p, __link_id) \
	ieee80211_beacon_get_tim(__hw, __vif, __ofst_p, __len_p)

#define ieee80211_nullfunc_get(__hw, __vif, __link_id, __qos_ok) \
	ieee80211_nullfunc_get(__hw, __vif, __qos_ok)

#define netif_napi_add(__netdev, __napi, __poll_func) \
	netif_napi_add(__netdev, __napi, __poll_func, NAPI_POLL_WEIGHT)
